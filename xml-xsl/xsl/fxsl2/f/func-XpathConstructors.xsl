...
-->
 ...
 <xsl:function name="f:yearMonthDuration" as="xdt:yearMonthDuration?">
   <xsl:param name="arg1" as="xdt:anyAtomicType?"/>
   
   <xsl:sequence select="xdt:yearMonthDuration($arg1)"/>
 </xsl:function>
...
-->
 ...
 <xsl:function name="f:dayTimeDuration" as="xdt:dayTimeDuration?">
   <xsl:param name="arg1" as="xdt:anyAtomicType?"/>
