...
xmlns:myFun1="f:myFun1" xmlns:myFun2="f:myFun2"
...
exclude-result-prefixes="xsl ext myFun1 myFun2">
  ...
  <xsl:variable name="vFun2"
  select="document('')/*/myFun2:*[1]" />Compose: (*3).(*2) 3 = 
