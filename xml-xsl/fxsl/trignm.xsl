...
exclude-result-prefixes="xsl trigSin trigCos trigTan trigCot trigSec trigCsc">
  ...
  <xsl:template name="_tan" match="trigTan:*">
    ...
    <xsl:choose>
      <xsl:when test="-$pEps &lt; $vdiffHalfPi and $vdiffHalfPi &lt; $pEps and $vnumHalfPis mod 2 = 1">
