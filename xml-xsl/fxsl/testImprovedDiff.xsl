...
exclude-result-prefixes="xsl myFunction">
  ...
  select="document('')/*/myFunction:*[1]" />f = x^2 x = 15 h0 = 0.1
  EpsRough = 0.0001 EpsImproved = 0.000000000001 f'(x) = 
  <xsl:text />
  ...
  </xsl:call-template>f = x^2 x = 0.5 h0 = 0.1 EpsRough = 0.0001
  EpsImproved = 0.0000000000001 f'(x) = 
  <xsl:text />
  <xsl:call-template name="improvedDiff">
    <xsl:with-param name="pFun" select="$vMyFun" />
  ...
  </xsl:call-template>f = x^2 x = 6 h0 = 0.1 EpsRough = 0.0001
  EpsImproved = 0.0000000000001 f'(x) = 
  <xsl:text />
  <xsl:call-template name="improvedDiff">
    <xsl:with-param name="pFun" select="$vMyFun" />
