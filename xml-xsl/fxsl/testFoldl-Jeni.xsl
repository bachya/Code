...
xmlns:pGenerator="pGenerator" xmlns:pController="pController"
exclude-result-prefixes="xsl pGenerator pController">
  ...
  <xsl:param name="pParams" />I should understand loops as being
  syntax for a simple form of recursion.</xsl:template>
